...
// Include the log_reports function
...
$report_content = "PDF generated for patient ID " . $patient['PatientID'];

// Log the report into the Reports table
log_report($conn, 'Individual', $report_content, $patient['PatientID']);
